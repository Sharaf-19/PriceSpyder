  ...
  return (
    <div className='product-container'>
      <div className='flex gap-28 xl:flex-row flex-col'>
        ...
        <div className='flex-1 flex flex-col'>
          <div className='flex justify-between items-start gap-5 flex-wrap pb-6'>
            ...
            <div className='flex items-center gap-3'>
              <div className='products-hearts'>
                <Image src='/assets/icons/red-heart.svg' alt='heart' width={20} height={20} />

                <p className='text-base font-semibold tex-[#D46F77]'>{product.reviewsCount}</p>
        ...
        <div className='felx flex-col gap-16 border-2 border-red-500'>
          <div className='flex flex-col gap-5'>
            <h3 className='text-2xl text-secondary font-semibold'>Product Desc</h3>
